    ...
    <div class="content_main">
      <div class="table_top_info d-between">
        ...
        <div class="r_btns d-center">
          ...
          <div class="item item_btn" @click="addContract()" v-if="user.role_id">
...
<script>
import addContract from "./component/add.vue";
import contractDetail from "./component/detail.vue";
  ...
  methods: {
    ...
    addContract(row) {
      if (this.user.role_id < 1) {
        return this.$warning("暂无企业，无法新建合同");
      }

      // console.log("新建、编辑合同  >>>", row);
