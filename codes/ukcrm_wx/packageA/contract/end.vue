      ...
      >
        <u-form-item>
          <view class="form_item d-between">
            <view class="l_label"> 合同编号 </view>
            <view class="r_info">{{ contract.contract_no || "" }}</view>
          </view>
        </u-form-item>
        <u-form-item>
          <view class="form_item d-between">
            <view class="l_label"> 合同名称 </view>
            <view class="r_info">{{ contract.contract_name || "" }}</view>
          </view>
        </u-form-item>

        <u-form-item>
          <view class="l_label"> 终止原因 </view>
          <view>
            <u--textarea
  ...
  methods: {
    ...
    overFollow() {
      postData(`contract/termination_contract`, {
        id: this.contract_id,
        ended_reason: this.info.remarks,
      }).then((res) => {
        const {
          code,
          data: { msg },
